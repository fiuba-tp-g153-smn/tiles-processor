...
ARG S3_TILES_DATA_ENDPOINT
ARG S3_TILES_DATA_ACCESS_KEY
ARG S3_TILES_DATA_SECRET_KEY
ARG S3_TILES_DATA_BUCKET_NAME
ARG S3_TILES_DATA_SECURE

ENV LOG_LEVEL=$LOG_LEVEL
ENV DATA_DIR_CONTAINER=$DATA_DIR_CONTAINER
ENV S3_TILES_DATA_ENDPOINT=$S3_TILES_DATA_ENDPOINT
ENV S3_TILES_DATA_ACCESS_KEY=$S3_TILES_DATA_ACCESS_KEY
ENV S3_TILES_DATA_SECRET_KEY=$S3_TILES_DATA_SECRET_KEY
ENV S3_TILES_DATA_BUCKET_NAME=$S3_TILES_DATA_BUCKET_NAME
ENV S3_TILES_DATA_SECURE=$S3_TILES_DATA_SECURE
